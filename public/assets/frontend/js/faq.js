...
const faqData = {
    ...
    "Apakah aplikasi Sistem Manajemen Anti Penyuapan (SMAP) Balai Pengujian Mutu dan Sertifikasi Produk Hewan (BPMSPH)?":
    ...
    Layanan: {
        ...
        "Uji Profisiensi":
            "<img src='/assets/frontend/images/Uji-Profisiensis.jpeg' alt='uji profisiensi' style='max-width: 100%; height: auto;'/>",
        "Tata Cara Pengiriman Sample": {
            Deskripsi: "Berikut adalah tata cara pengiriman sample:",
            Gambar: [
                "<img src='/assets/frontend/images/Tata-Cara-Pengiriman-Sampel.jpg' alt='Tata Cara Pengiriman Sample' style='max-width: 100%; height: auto;'/>",
                "<img src='/assets/frontend/images/persyaratan-pengujian.jpeg' alt='Persyaratan Pengujian' style='max-width: 100%; height: auto;'/>",
            ],
        },
        "Tarif Uji": {
            Deskripsi:
            ...
            Gambar: [
                "<img src='/assets/frontend/images/Tarif-uji1.jpg' alt='Tarif Uji' style='max-width: 100%; height: auto;'/>",
                "<img src='/assets/frontend/images/Tarif-uji2.jpg' alt='Tarif Uji' style='max-width: 100%; height: auto;'/>",
            ],
        },
        "Tarif dan Fasilitas Sewa Ruang Rapat dan Kamar Tamu Gedung BIMTEK": {
            ...
            Gambar: [
                "<img src='/assets/frontend/images/tarif-sewa1.jpeg' alt='Tarif Sewa Bimtek' style='max-width: 100%; height: auto;'/>",
                "<img src='/assets/frontend/images/tarif-sewa2.jpeg' alt='Tarif Sewa Bimtek' style='max-width: 100%; height: auto;'/>",
                "<img src='/assets/frontend/images/alur-permohonan-sewa.jpg' alt='Alur Permohonan Sewa Bimtek' style='max-width: 100%; height: auto;'/>",
            ],
        },
        "Tarif Layanan Magang, PKL dan Bimbingan Teknis": {
            ...
            Gambar: [
                "<img src='/assets/frontend/images/persyaratan-pelayanan.jpeg' alt='Persyaratan Pelayanan' style='max-width: 100%; height: auto;'/>",
                "<img src='/assets/frontend/images/prosedur-pelayanan.jpeg' alt='Prosedur Pelayanan' style='max-width: 100%; height: auto;'/>",
                "<img src='/assets/frontend/images/tarif-magang.jpg' alt='Tarif Magang' style='max-width: 100%; height: auto;'/>",
            ],
        },
    },
};
...
function handleChat() {
    createChatMessage(
        "Halo, selamat datang di Frequently Asked Question (FAQ). Silahkan tekan mulai untuk melihat pertanyaan yang sering ditanyakan.",
        "incoming"
    );
